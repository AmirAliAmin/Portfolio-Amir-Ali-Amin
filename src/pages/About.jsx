    ...
    <div className="flex flex-wrap sm:flex-row flex-col items-center min-h-screen justify-center gap-10  w-full bg-black text-white lg:pt-15 md:pt-20 px-4 md:px-10 lg:px-15">
      <div className="lg:w-[40%] w-full flex h-full  items-center justify-center lg:justify-start overflow-hidden">
        <img
          ...
          className="bg-gray-950 h-130 transition-all hover:scale-120 cursor-pointer"
        />
      </div>
      <div className="lg:w-[50%] w-full h-full  flex flex-col justify-center">
        <h1 className="text-5xl font-extrabold mb-4 text-center lg:text-start">
          About Me
        </h1>
        ...
        <p className="font-light">
          ...
          dynamic, user-friendly applications. With a strong foundation in
          modern web technologies, I specialize in building seamless digital
          experiences that combine aesthetic appeal with functional excellence.
        </p>
        <div className="flex flex-wrap mt-5">
          <ul className="flex flex-wrap gap-5">
            <li
              className={`cursor-pointer ${
                activeTab === "mainSkill" ? "border-b-2 border-red-400" : ""
              }`}
            ...
            <li
              className={`cursor-pointer ${
                activeTab === "award" ? "border-b-2 border-red-400" : ""
              }`}
            ...
            <li
              className={`cursor-pointer ${
                activeTab === "experience" ? "border-b-2 border-red-400" : ""
              }`}
            ...
            <li
              className={`cursor-pointer ${
                activeTab === "education" ? "border-b-2 border-red-400" : ""
              }`}
        ...
        {activeTab === "award" && (
          <div className="mt-4 space-y-4">
            <div>
              ...
              <p className="text-gray-300 sm:text-sm text-xs">
                Awarded a laptop through competitive government scholarship
                program
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-300 sm:text-sm text-xs">
                Selected for prestigious scholarship based on academic
                excellence
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-300 sm:text-sm text-xs">
                Completed my Degree with 3.85 Cgpa
              </p>
            </div>
          </div>
        )}
          ...
          <div className="mt-4 space-y-6">
            <div>
              <h1 className="font-semibold">
                ...
                <span className="text-xs text-gray-400">Lead Concept</span>{" "}
              </h1>
              <p className="text-gray-300 sm:text-sm text-xs">
                Leading web development initiatives and implementing innovative
                solutions
              </p>
            ...
            <div>
              <h1 className="font-semibold">
                Frontend Developer -
                <span className="text-xs text-gray-400">Coding First</span>
              </h1>
              <p className="text-gray-300 sm:text-sm text-xs">
                Leading frontend development initiatives and implementing
        ...
        {activeTab === "education" && (
          <div className="mt-4 space-y-6">
            <div>
              ...
              <p className="text-gray-300 sm:text-sm text-xs">
                Comprehensive education in software development principles and
                practices
              </p>
