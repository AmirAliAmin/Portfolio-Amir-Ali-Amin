...
export default function Portfolio() {
  const projects = [
    ...
    },
    {
      ...
      image: project2,
      description:
        "Full-featured online shopping platform with cart & checkout",
      category: "E-commerce",
  ...
  return (
    <div className="bg-black h-fit text-white pt-20 pb-10 mx-8">
      <div className="flex flex-col items-center text-center mb-12">
        <h1 className="font-extrabold text-5xl mb-4">My Latest Projects</h1>
        <p className="text-gray-400 text-lg">
          Showcasing innovative web solutions where creativity meets
          functionality
        </p>
      </div>
        ...
        {projects.map((project) => (
          ...
          >
            <div className="relative overflow-hidden">
              ...
              />
              {/* Hover Overlay */}
              <div className="absolute inset-0 rounded-t-lg bg-[#000000d2] bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
