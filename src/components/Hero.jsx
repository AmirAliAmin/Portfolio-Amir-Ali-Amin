...
export default function Hero() {
  return (
    <div className="bg-black text-white flex min-h-screen py-5 sm:flex-row flex-col-reverse px-5 sm:px-5 items-center justify-center md:px-10 lg:px-30 sm:gap-20 gap-5 pt-20 relative overflow-hidden">
      {/* Content Section */}
      <div className="sm:w-[50%] w-full pb-2 z-10">
        <span className="relative inline-flex h-10 w-10 top-10">
